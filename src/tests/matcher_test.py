...
class MatcherTestCase(unittest.TestCase):
    ...
    def test_simple_message(self):
        ...
        test_event = Event("I AM A Testmessage")
        assert current_matcher.matches(test_event) == True

        test_event = Event("I AM A non matching Testmessage")
        ...
        test_event = Event("I AM A Testmessage")
        assert current_matcher.matches(test_event) == True
        test_event = Event("Idsfdsfdsfdsfdsf AM A Testmessage test123")
    ...
    def test_matcher_memory(self):
        ...
        """
        test_event = Event("test123 AM A Testmessage test123")
    ...
    def test_simple_numeric(self):
        ...
        """
        test_event = Event("ignore my message", time.ctime(),{
            "severity" : 4,
            "availability" : 0.995
        })
    ...
    def test_ip_operators(self):
        ...
        """
        test_event = Event("blobb", time.ctime(),{
